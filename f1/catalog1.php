...
if (isset($_POST['post_comment']) && $user_id) {
    ...
    header("Location: catalog1.php?category=" . $category_param . "&message=" . urlencode($message_status));
    exit;
}
...
<header>
    <nav class="nav-links">
        ...
        <a href="catalog2.php">Каталог2</a>
...
<div class="main-block" style="max-width: 900px;">
    ...
    <div class="category-filter">
        ...
        <a href="catalog1.php" class="filter-link <?php echo $active_all; ?>">Все товары</a>
        <?php
        ...
        while ($cat_row = mysqli_fetch_assoc($category_result)) {
            ...
            echo "<a href=\"catalog1.php?category=" . urlencode($cat_name) . "\" class=\"filter-link $active_class\">" . $cat_name . "</a>";
        }
        ?>
    </div>
