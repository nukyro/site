...
if (isset($_POST['auto']) && $_POST['auto'] == 'Войти') {
    ...
    if ($result) {
        ...
        if ($row && mysqli_num_rows($result) == 1) {
            ...
            echo '<form action="sql.php" method="post" style="text-align:center;">
                    <input type="submit" name="out" value="Выход">
                </form>';
            
        } else {
            echo '<div class="message message-error">Данные не верны, попробуйте ещё раз <a href="autosql.php">Войти</a></div>';
        }
    } else {
    ...
    echo '<form action="autosql.php" method="post" style="text-align:center;">
            <input type="submit" name="out" value="Выход">
        </form>';
...
<form action="autosql.php" method="post">
